...
router.post('/create', auth_1.verifyToken, (0, validateRequest_1.validateRequest)(product_validator_1.productSchema), product_controller_1.default.create);
router.get('/filter', product_controller_1.default.filterProducts);
