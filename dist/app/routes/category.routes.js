...
router.post('/create', (0, validateRequest_1.validateRequest)(category_validator_1.categorySchema), categories_controller_1.default.create);
router.post('/create-all', categories_controller_1.default.createAll);
